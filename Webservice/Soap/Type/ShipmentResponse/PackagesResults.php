...
/**
 * The packages result provides the DHL piece ID associated to each RequestedPackage from the ShipmentRequest.
 * In this case, the TrackingNumber is the Piece ID returned from the service. In order to tie the RequestedPackages
 * from the ShipmentRequest with the PackageResult in the response, the @number attribute is used to referentially
