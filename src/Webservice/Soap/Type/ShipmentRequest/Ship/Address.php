...
class Address extends CommonAddress
{
	 ...
	 * @param string $stateOrProvince The US state code
	 */
    public function __construct($streetLines, $city, $postalCode, $countryCode, $stateOrProvince)
    {
        parent::__construct($city, $postalCode, $countryCode);

        $this->setStreetLines($streetLines);
	    $this->setStateOrProvinceCode($stateOrProvince);
    }
}
