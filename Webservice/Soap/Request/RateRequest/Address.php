...
use Dhl\Express\Webservice\Soap\Request\RateRequest\Value\StateOrProvinceCode;
use Dhl\Express\Webservice\Soap\Request\RateRequest\Value\StreetLines;
use Dhl\Express\Webservice\Soap\Request\RateRequest\Value\StreetNumber;
...
class Address
{
     ...
     *
     * @param null|string $streetLines The shippers/recipients street address
     *
     * @return self
     */
     ...
     *
     * @param null|string $streetLines2 The additional shippers/recipients street address information,
     ...
     *
     * @param null|string $streetLines3 The additional shippers/recipients street address information,
     ...
     *
     * @param null|string $streetName The shippers/recipients street name
     *
     * @return self
     */
     ...
     *
     * @param null|string $stateOrProvinceCode The shippers/recipients state or province code
     *
     * @return self
     */
