...
use Dhl\Express\Webservice\Soap\Request\RateRequest\Value\ShipTimestamp;
...
class RequestedShipment implements ArrayInterface
{
     ...
     *
     * @param null|Billing $billing The billing section
     *
     * @return self
     */
     ...
     *
     * @param null|Services $specialServices The special services section
     *
     * @return self
     */
    public function setSpecialServices(?Services $specialServices): RequestedShipment
    {
    ...
    /**
     * Returns the requested value added services section.
     *
    ...
    /**
     * Gets the requested value added services section.
     *
     * @param null|string $requestValueAddedServices The requested value added services section
     *
     * @return self
     */
